        ...
        <div className="page-section">
          ...
          <div className="about-content">
            <p className="about-description">
              ...
              Malone announced via email and posted on our 
                <Link href="https://www.instagram.com/jhuacm/" className="about-link" target="_blank" rel="noopener noreferrer"> Instagram </Link>
                page and the 
                <Link href="/events" className="about-link"> Events </Link> section of this website.
            </p>    
